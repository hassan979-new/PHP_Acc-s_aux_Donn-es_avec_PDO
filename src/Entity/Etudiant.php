...
class Etudiant
{
    ...
    {
        $cne = trim($cne);
        if ($cne === '') { throw new \InvalidArgumentException('cne Obligatoire!'); }
        $this->cne = $cne;
    }
    ...
    {
        $prenom = trim($prenom);
        if ($prenom === '') { throw new \InvalidArgumentException('prenom Obligatoire'); }
        $this->prenom = $prenom;
    }
    ...
    {
        if ($filiereId <= 0) { throw new \InvalidArgumentException('filiere_id > 0!'); }
