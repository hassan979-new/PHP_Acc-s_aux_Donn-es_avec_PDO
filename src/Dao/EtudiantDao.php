...
class EtudiantDao
{
    ...
    public function insert(Etudiant $e): int
    {
        ...
        try {
            ...
            $this->logger->erreur($ex->getMessage(), [
    ...
    public function update(Etudiant $e): bool
    {
        ...
        try {
            ...
            $this->logger->erreur($ex->getMessage(), ['method' => __METHOD__, 'sql' => $sql, 'id' => $e->getId()]);
            throw $ex;
        }
    }
    ...
    public function delete(int $id): bool
    {
        ...
        try {
            ...
            $this->logger->erreur($ex->getMessage(), ['method' => __METHOD__, 'sql' => $sql, 'id' => $id]);
            throw $ex;
        }
    }
    ...
    public function findAll(): array
    {
        ...
        try {
            ...
            $this->logger->erreur($ex->getMessage(), ['method' => __METHOD__, 'sql' => $sql]);
            throw $ex;
        }
    }
}