...
class FiliereDao
{
    ...
    public function insert(Filiere $f): int
    {
        ...
        try {
            ...
            $this->logger->erreur($e->getMessage(), ['method' => __METHOD__, 'sql' => $sql]);
            throw $e;
        }
    }
    ...
    public function update(Filiere $f): bool
    {
        ...
        try {
            ...
            $this->logger->erreur($e->getMessage(), ['method' => __METHOD__, 'sql' => $sql, 'id' => $f->getId()]);
            throw $e;
        }
    }
    ...
    public function delete(int $id): bool
    {
        ...
        try {
            ...
            $this->logger->erreur($e->getMessage(), ['method' => __METHOD__, 'sql' => $sql, 'id' => $id]);
            throw $e;
        }
    }
